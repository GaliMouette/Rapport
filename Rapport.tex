...
\title{
    Stage :\\[1em]
    % Application spontanée de transformations pour raisonnement automatique en théorie des types dépendants
...
% TODO : Correction : ils sont pas juste limités à logique du premier ordre sans quantificateur
% TODO : Deux modules :
% TODO : - module logique propositionnelle : pas de quantificateur
% TODO : - module théorie : Ajoute axiomes et quelques constantes et quelques fonctions, cherches des instances pour les quantificateurs
% TODO : SAT trouve valuation/modèle, si formule compatible avec quantif alors OK, si ne marche pas au niveau quantif on relance SAT avec d'autres valuation
